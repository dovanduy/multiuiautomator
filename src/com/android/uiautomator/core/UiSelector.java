		...
		Selector selector = new Selector();
	     ...
	     final int criterionCount = mSelectorAttributes.size();
	        for (int i = 0; i < criterionCount; i++) {
	            ...
	            switch (criterion) {
	            case SELECTOR_TEXT:
	            	selector.setText((String) mSelectorAttributes.valueAt(i)); 
	            	break;
	            case SELECTOR_TEXT_REGEX:
	            	selector.setTextMatches((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_START_TEXT:
	            	selector.setTextStartsWith((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CONTAINS_TEXT:
	            	selector.setTextContains((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CLASS:
	            	selector.setClassName((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CLASS_REGEX:
	            	selector.setClassNameMatches((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_DESCRIPTION:
	            	selector.setDescription((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_DESCRIPTION_REGEX:
	            	selector.setDescriptionMatches((String) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_START_DESCRIPTION:
	            	selector.setDescriptionStartsWith((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CONTAINS_DESCRIPTION:
	            	selector.setDescriptionContains((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_INDEX:
	            	selector.setIndex((Integer) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_INSTANCE:
	            	selector.setInstance((Integer) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_ENABLED:
	            	selector.setEnabled((Boolean) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_FOCUSED:
	            	selector.setFocused((Boolean) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_FOCUSABLE:
	            	selector.setFocusable((Boolean) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_SCROLLABLE:
	            	selector.setScrollable((Boolean) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CLICKABLE:
	            	selector.setClickable((Boolean) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_CHECKABLE:
	            	selector.setCheckable((Boolean) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_LONG_CLICKABLE:
	            	selector.setLongClickable((Boolean) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_CHECKED:
	            	selector.setChecked((Boolean) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_SELECTED:
	            	selector.setSelected((Boolean) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_PACKAGE_NAME:
	            	selector.setPackageName((String) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_PACKAGE_NAME_REGEX:
	            	selector.setPackageNameMatches((String) mSelectorAttributes.valueAt(i));
	            	break;
	            case SELECTOR_RESOURCE_ID:
	            	selector.setResourceId((String) mSelectorAttributes.valueAt(i));
	                break;
	            case SELECTOR_RESOURCE_ID_REGEX:
	            	selector.setResourceIdMatches((String) mSelectorAttributes.valueAt(i));
	                break;
	            default:
	            	throw new UnsupportedOperationException("Unknown type of selector criterion " + criterion);
	            }
	        }
